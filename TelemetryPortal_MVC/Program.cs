...
builder.Services.AddScoped<InterfaceProjectRepository, ProjectRepository>();
builder.Services.AddScoped(typeof(InterfaceGenericRepository<>), typeof(GenericRepository<>));
